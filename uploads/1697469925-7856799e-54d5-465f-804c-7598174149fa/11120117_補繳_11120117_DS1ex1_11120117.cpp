...
void GoShortestRight( chunk * currentPoint, int currentLength, int & shortestLength ) ;
void GoShortestDown( chunk * currentPoint, int currentLength, int & shortestLength ) ;
void GoShortestLeft( chunk * currentPoint, int currentLength, int & shortestLength ) ;
void GoShortestUp( chunk * currentPoint, int currentLength, int & shortestLength ) ;
...
void GoShortestRight( chunk * currentPoint, int currentLength, int & shortestLength ) {
  ...
  // cout << "Right:(" << currentPoint -> line << "," << currentPoint -> column << ")" << endl ; // test-line 
  ...
  if ( currentPoint -> right != NULL && currentPoint -> right -> status == 'E' && currentLength < shortestLength )
    GoShortestRight( currentPoint -> right, currentLength + 1, shortestLength ) ;  

  if ( currentPoint -> right != NULL && currentPoint -> right -> status == 'G' && currentLength < shortestLength ) {
    shortestLength = currentLength ;
    return ; 
  }
  // down

  if ( currentPoint -> down != NULL && currentPoint -> down -> status == 'E' && currentLength < shortestLength )
    GoShortestDown( currentPoint -> down, currentLength + 1, shortestLength ) ;  

  if ( currentPoint -> down != NULL && currentPoint -> down -> status == 'G' && currentLength < shortestLength ) {
    shortestLength = currentLength ;
    return ; 
  }
  ...
  if ( currentPoint -> left != NULL && currentPoint -> left -> status == 'E' && currentLength < shortestLength )
    GoShortestLeft( currentPoint -> left, currentLength + 1, shortestLength ) ;  

  if ( currentPoint -> left != NULL && currentPoint -> left -> status == 'G' && currentLength < shortestLength ) {
    shortestLength = currentLength ;
    return ; 
  }
  ...
  if ( currentPoint -> up != NULL && currentPoint -> up -> status == 'E' && currentLength < shortestLength )
    GoShortestUp(  currentPoint -> up, currentLength + 1, shortestLength ) ;  

  if ( currentPoint -> up != NULL && currentPoint -> up -> status == 'G' && currentLength < shortestLength ) {
    shortestLength = currentLength ;
    return ; 
  }
...
void GoShortestDown( chunk * currentPoint, int currentLength, int & shortestLength ) {
  ...
  // cout << "Down:(" << currentPoint -> line << "," << currentPoint -> column << ")" << endl ; // test-line 
...
void GoShortestLeft( chunk * currentPoint, int currentLength, int & shortestLength ) {
  ...
  // cout << "Left:(" << currentPoint -> line << "," << currentPoint -> column << ")" << endl ; // test-line 
...
void GoShortestUp( chunk * currentPoint, int currentLength, int & shortestLength ) {
  ...
  // cout << "Up:(" << currentPoint -> line << "," << currentPoint -> column << ")" << endl ; // test-line 
  ...
  if ( currentPoint -> left != NULL && currentPoint -> left -> status == 'E' && currentLength < shortestLength )
    GoShortestLeft( currentPoint -> right, currentLength + 1, shortestLength ) ;  
...
bool UI( int & NumOfGoals, bool & shortest ) {
  ...
  // cout << "(" << start -> line << "," << start -> column << ")" << endl ; // test-line
    ...
    if ( ! error ) {
      ...
      if ( ! shortest )
        ...
        GoShortestRight( start, currentLength, shortestLength ) ;
        shortest = false ;
      }
      PrintPath( start ) ;
